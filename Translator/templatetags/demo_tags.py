...
@register.inclusion_tag('Translator/tags/top_menu.html', takes_context=True)
...
@register.inclusion_tag('Translator/tags/top_menu_children.html', takes_context=True)
...
@register.inclusion_tag(
    'Translator/tags/standard_index_listing.html',
    takes_context=True
)
...
@register.inclusion_tag(
    'Translator/tags/person_listing_homepage.html',
    takes_context=True
)
...
@register.inclusion_tag(
    'Translator/tags/blog_listing_homepage.html',
    takes_context=True
)
...
@register.inclusion_tag(
    'Translator/tags/event_listing_homepage.html',
    takes_context=True
)
...
# Advert snippets
@register.inclusion_tag('Translator/tags/adverts.html', takes_context=True)
def adverts(context):
    return {
...
@register.inclusion_tag('Translator/tags/breadcrumbs.html', takes_context=True)
